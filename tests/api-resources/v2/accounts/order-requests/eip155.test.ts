...
describe('resource eip155', () => {
  ...
  test.skip('createPermit: only required params', async () => {
    const responsePromise = client.v2.accounts.orderRequests.eip155.createPermit('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
    chain_id: 'eip155:1',
    order_side: 'BUY',
    order_tif: 'DAY',
    order_type: 'MARKET',
  ...
  test.skip('createPermitTransaction: only required params', async () => {
    const responsePromise = client.v2.accounts.orderRequests.eip155.createPermitTransaction('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { order_request_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', permit_signature: '0xeaF12bD1DfFd' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('submit: only required params', async () => {
    const responsePromise = client.v2.accounts.orderRequests.eip155.submit('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { order_request_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', permit_signature: '0xeaF12bD1DfFd' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
