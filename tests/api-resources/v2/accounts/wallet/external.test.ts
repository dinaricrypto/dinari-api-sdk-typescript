...
describe('resource external', () => {
  ...
  test.skip('connect: only required params', async () => {
    const responsePromise = client.v2.accounts.wallet.external.connect('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
    chain_id: 'eip155:0',
  ...
  test.skip('connect: required and optional params', async () => {
    const response = await client.v2.accounts.wallet.external.connect('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
    chain_id: 'eip155:0',
    nonce: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    signature: '0xeaF12bD1DfFd',
    wallet_address: 'wallet_address',
  ...
  test.skip('getNonce: only required params', async () => {
    const responsePromise = client.v2.accounts.wallet.external.getNonce('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { chain_id: 'eip155:0', wallet_address: 'wallet_address' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
