...
describe('resource accounts', () => {
  ...
  test.skip('getDividendPayments: only required params', async () => {
    const responsePromise = client.v2.accounts.getDividendPayments('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { end_date: '2019-12-27', start_date: '2019-12-27' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('getInterestPayments: only required params', async () => {
    const responsePromise = client.v2.accounts.getInterestPayments('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { end_date: '2019-12-27', start_date: '2019-12-27' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('getPortfolio: request options and params are passed correctly', async () => {
    ...
    await expect(client.v2.accounts.getPortfolio('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { page: 1, page_size: 1 }, { path: '/_stainless_unknown_path' }))
      .rejects
