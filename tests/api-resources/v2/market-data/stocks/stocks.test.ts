...
describe('resource stocks', () => {
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.v2.marketData.stocks.list({
    limit: 20,
    next: 'next',
    order: 'asc',
    page: 1,
  ...
  test.skip('retrieveCurrentPrice', async () => {
    const responsePromise = client.v2.marketData.stocks.retrieveCurrentPrice('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieveCurrentQuote', async () => {
    const responsePromise = client.v2.marketData.stocks.retrieveCurrentQuote('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieveDividends', async () => {
    const responsePromise = client.v2.marketData.stocks.retrieveDividends('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieveHistoricalPrices: only required params', async () => {
    const responsePromise = client.v2.marketData.stocks.retrieveHistoricalPrices('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { timespan: 'DAY' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieveNews: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.v2.marketData.stocks.retrieveNews('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { limit: 1 }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Dinari.NotFoundError);
  });
});
