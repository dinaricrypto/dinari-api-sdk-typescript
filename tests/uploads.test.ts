import fs from 'fs';
import type { ResponseLike } from '@dinari/api-sdk/internal/to-file';
import { toFile } from '@dinari/api-sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@dinari/api-sdk/core/uploads');
    await expect(
