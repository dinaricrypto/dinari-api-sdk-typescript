...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "description": "Get a list of all `Orders` under the `Entity`.<br>Optionally `Orders` can be transaction hash or fulfillment transaction hash.",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/market_data/market_hours/ \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/market_data/stocks/ \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "description": "Get historical price data for a specified `Stock`. Each index in the array represents a single tick in a price chart.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/market_data/stocks/$STOCK_ID/historical_prices/ \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/market_data/stocks/$STOCK_ID/news \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/market_data/stocks/$STOCK_ID/dividends \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/market_data/stocks/$STOCK_ID/current_price \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/market_data/stocks/$STOCK_ID/current_quote \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; ex_date: string; payable_date: string; record_date: string; split_from: number; split_to: number; status: 'PENDING' | 'IN_PROGRESS' | 'COMPLETE'; stock_id: string; }[] | { data: { id: string; ex_date: string; payable_date: string; record_date: string; split_from: number; split_to: number; status: 'PENDING' | 'IN_PROGRESS' | 'COMPLETE'; stock_id: string; }[]; pagination_metadata: { next?: string; previous?: string; }; _sv?: 'PaginatedStockSplitResponse:v1'; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/market_data/stocks/splits \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/market_data/stocks/$STOCK_ID/splits \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ data: { id: string; is_tradable: boolean; name: string; symbol: string; _sv?: 'Alloy:v1'; }[]; pagination_metadata: { next?: string; previous?: string; }; _sv?: 'PaginatedAlloyResponse:v1'; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/market_data/alloys/ \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/market_data/alloys/$ALLOY_ID/current_price \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "description": "Get historical price data for a specified `Alloy`. Each index in the array represents a single tick in a price chart.",
    ...
    "response": "{ close: number; high: number; low: number; open: number; timestamp: number; _sv?: 'AlloyHistoricalPriceDataPointV1:v1'; }[]",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/market_data/alloys/$ALLOY_ID/historical_prices/ \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; entity_type: 'INDIVIDUAL' | 'ORGANIZATION'; is_kyc_complete: boolean; name?: string; nationality?: string; reference_id?: string; }[] | { data: { id: string; entity_type: 'INDIVIDUAL' | 'ORGANIZATION'; is_kyc_complete: boolean; name?: string; nationality?: string; reference_id?: string; }[]; pagination_metadata: { next?: string; previous?: string; }; _sv?: 'PaginatedEntityResponse:v1'; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/entities/ \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; entity_type: 'INDIVIDUAL' | 'ORGANIZATION'; is_kyc_complete: boolean; name?: string; nationality?: string; reference_id?: string; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/entities/me \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/entities/$ENTITY_ID \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; created_dt: string; entity_id: string; is_active: boolean; jurisdiction: 'BASELINE' | 'US'; brokerage_account_id?: string; }[] | { data: { id: string; created_dt: string; entity_id: string; is_active: boolean; jurisdiction: 'BASELINE' | 'US'; brokerage_account_id?: string; }[]; pagination_metadata: { next?: string; previous?: string; }; _sv?: 'PaginatedAccountResponse:v1'; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/entities/$ENTITY_ID/accounts \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; created_dt: string; entity_id: string; is_active: boolean; jurisdiction: 'BASELINE' | 'US'; brokerage_account_id?: string; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/entities/$ENTITY_ID/kyc \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/entities/$ENTITY_ID/kyc/url \\\n    -X POST \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; document_type: 'GOVERNMENT_ID' | 'SELFIE' | 'RESIDENCY' | 'UNKNOWN'; filename: string; url: string; }[]",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/entities/$ENTITY_ID/kyc/$KYC_ID/document \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/deactivate \\\n    -X POST \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/portfolio \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/cash \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/interest_payments \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/dividend_payments \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/faucet \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/wallet \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/wallet/internal \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\" \\\n    -d '{\n          \"chain_id\": \"eip155:0\",\n          \"wallet_address\": \"wallet_address\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/wallet/external/nonce \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/wallet/external \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\" \\\n    -d '{\n          \"chain_id\": \"eip155:0\",\n          \"nonce\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n          \"signature\": \"0xeaF12bD1DfFd\",\n          \"wallet_address\": \"wallet_address\"\n        }'"
      }
    }
  },
  {
    ...
    "httpMethod": "get",
    "summary": "Get Orders",
    "description": "Get a list of all `Orders` under the `Account`.<br>Optionally `Orders` can be filtered by chain ID, transaction hash, or client order ID.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/orders \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/orders/$ORDER_ID \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/orders/$ORDER_ID/fulfillments \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/orders/cancel \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\" \\\n    -d '{\n          \"order_ids\": [\n            \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/orders/$ORDER_ID/cancel \\\n    -X POST \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/order_fulfillments \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; asset_token_filled: number; asset_token_spent: number; chain_id: string; order_id: string; payment_token_filled: number; payment_token_spent: number; transaction_dt: string; transaction_hash: string; alloy_id?: string; payment_token_fee?: number; stock_id?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/order_fulfillments/$ORDER_FULFILLMENT_ID \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/order_requests/market_buy \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\" \\\n    -d '{\n          \"payment_amount\": 0\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/order_requests/market_sell \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\" \\\n    -d '{\n          \"asset_quantity\": 0\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/order_requests/limit_buy \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\" \\\n    -d '{\n          \"asset_quantity\": 0,\n          \"limit_price\": 0\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/order_requests/limit_sell \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\" \\\n    -d '{\n          \"asset_quantity\": 0,\n          \"limit_price\": 0\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/order_requests \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/order_requests/$ORDER_REQUEST_ID \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/order_requests/fee_quote \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\" \\\n    -d '{\n          \"order_side\": \"BUY\",\n          \"order_type\": \"MARKET\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/order_requests/eip155/permit \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\" \\\n    -d '{\n          \"chain_id\": \"eip155:1\",\n          \"order_side\": \"BUY\",\n          \"order_tif\": \"DAY\",\n          \"order_type\": \"MARKET\",\n          \"payment_token\": \"payment_token\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/order_requests/eip155/permit_transaction \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\" \\\n    -d '{\n          \"order_request_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n          \"permit_signature\": \"0xeaF12bD1DfFd\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ id: string; account_id: string; created_dt: string; order_side: 'BUY' | 'SELL'; order_tif: 'DAY' | 'GTC' | 'IOC' | 'FOK'; order_type: 'MARKET' | 'LIMIT'; status: string; cancel_message?: string; order_id?: string; recipient_account_id?: string; reject_message?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/order_requests/eip155 \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\" \\\n    -d '{\n          \"order_request_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n          \"permit_signature\": \"0xeaF12bD1DfFd\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ id: string; account_id: string; created_dt: string; payment_token_amount: number; recipient_account_id: string; status: 'PENDING' | 'SUBMITTED' | 'ERROR' | 'CANCELLED'; updated_dt: string; }[] | { data: { id: string; account_id: string; created_dt: string; payment_token_amount: number; recipient_account_id: string; status: 'PENDING' | 'SUBMITTED' | 'ERROR' | 'CANCELLED'; updated_dt: string; }[]; pagination_metadata: { next?: string; previous?: string; }; _sv?: 'PaginatedWithdrawalRequestResponse:v1'; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/withdrawal_requests \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; account_id: string; created_dt: string; payment_token_amount: number; recipient_account_id: string; status: 'PENDING' | 'SUBMITTED' | 'ERROR' | 'CANCELLED'; updated_dt: string; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/withdrawal_requests/$WITHDRAWAL_REQUEST_ID \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/withdrawals \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; account_id: string; chain_id: string; payment_token_address: string; payment_token_amount: number; recipient_account_id: string; status: string; transaction_dt: string; transaction_hash: string; withdrawal_request_id: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/withdrawals/$WITHDRAWAL_ID \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/token_transfers \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; chain_id: string; created_dt: string; quantity: number; recipient_account_id: string; sender_account_id: string; status: 'PENDING' | 'IN_PROGRESS' | 'COMPLETE' | 'FAILED'; token_address: string; updated_dt: string; transaction_hash?: string; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/token_transfers/$TRANSFER_ID \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api-enterprise.sbt.dinari.com/api/v2/accounts/$ACCOUNT_ID/activities/brokerage \\\n    -H \"X-API-Key-Id: $DINARI_API_KEY_ID\" \\\n    -H \"X-API-Secret-Key: $DINARI_API_SECRET_KEY\""
      }
    }
  }
];
